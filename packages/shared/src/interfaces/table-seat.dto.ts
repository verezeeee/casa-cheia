 ...
 *
 * Quando o assento está vago, `userId`, `userName` e `currentStack` são `null`.
 * `currentStack` é o dinheiro que está NA MESA — ele saiu da Wallet no buy-in
 * e só volta para lá no cash-out; os dois saldos jamais são somados na UI.
 */
